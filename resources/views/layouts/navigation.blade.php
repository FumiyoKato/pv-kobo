        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="https://www.weatherdatascience.tokyo/" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset('img/WDSlogo.png') }}" alt="Company Logo" class="h-12 w-auto">
                   </a>
                </div>
            </div>
            ...
            <div class="flex items-center">
                <a href="{{ url('/') }}" class="inline-flex items-center">
                    <h1 class="text-2xl font-bold text-gray-800" style="font-family: 'Noto Sans JP', sans-serif;">ＰＶ予測セルフ工房</h1>
                </a>
            </div>
